...
api/samples/CMakeFiles/memtrace.dir/memtrace.c.o: ../api/samples/memtrace.c
	...
	cd /home/andrew/Dropbox/School/rcos/dr-vis/dynamorio/build/api/samples && /usr/bin/cc  $(C_DEFINES) $(C_FLAGS)  -DDEBUG -DX86_64 -DLINUX -DUSE_VISIBILITY_ATTRIBUTES  -m64 -std=gnu99 -fno-strict-aliasing -fno-stack-protector -fvisibility=internal -g3 -fno-omit-frame-pointer -fno-builtin-strcmp -Wall -Werror -Wwrite-strings -Wno-unused-but-set-variable -fno-stack-protector -o CMakeFiles/memtrace.dir/memtrace.c.o   -c /home/andrew/Dropbox/School/rcos/dr-vis/dynamorio/api/samples/memtrace.c
...
api/samples/CMakeFiles/memtrace.dir/memtrace.c.i: cmake_force
	...
	cd /home/andrew/Dropbox/School/rcos/dr-vis/dynamorio/build/api/samples && /usr/bin/cc  $(C_DEFINES) $(C_FLAGS)  -DDEBUG -DX86_64 -DLINUX -DUSE_VISIBILITY_ATTRIBUTES  -m64 -std=gnu99 -fno-strict-aliasing -fno-stack-protector -fvisibility=internal -g3 -fno-omit-frame-pointer -fno-builtin-strcmp -Wall -Werror -Wwrite-strings -Wno-unused-but-set-variable -fno-stack-protector -E /home/andrew/Dropbox/School/rcos/dr-vis/dynamorio/api/samples/memtrace.c > CMakeFiles/memtrace.dir/memtrace.c.i
...
api/samples/CMakeFiles/memtrace.dir/memtrace.c.s: cmake_force
	...
	cd /home/andrew/Dropbox/School/rcos/dr-vis/dynamorio/build/api/samples && /usr/bin/cc  $(C_DEFINES) $(C_FLAGS)  -DDEBUG -DX86_64 -DLINUX -DUSE_VISIBILITY_ATTRIBUTES  -m64 -std=gnu99 -fno-strict-aliasing -fno-stack-protector -fvisibility=internal -g3 -fno-omit-frame-pointer -fno-builtin-strcmp -Wall -Werror -Wwrite-strings -Wno-unused-but-set-variable -fno-stack-protector -S /home/andrew/Dropbox/School/rcos/dr-vis/dynamorio/api/samples/memtrace.c -o CMakeFiles/memtrace.dir/memtrace.c.s
...
api/samples/bin/libmemtrace.so: lib64/debug/libdynamorio.so.4.1
api/samples/bin/libmemtrace.so: ext/lib64/debug/libdrmgr.so
api/samples/bin/libmemtrace.so: ext/lib64/debug/libdrutil.so
api/samples/bin/libmemtrace.so: ext/lib64/debug/libdrmgr.so
api/samples/bin/libmemtrace.so: ext/lib64/debug/libdrx.so
api/samples/bin/libmemtrace.so: lib64/debug/libdynamorio.so.4.1
